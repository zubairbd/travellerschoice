        ...
        <div class="page-inner-title">
            <div class="container">
                <div class="row text-left">
                    <div class="col-12"><h3>কোভিড-১৯ টিকা সনদপত্র সংগ্রহ</h3></div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4 col-xs-12 wrapper-left-navmenu">
                        <ul>
                            ...
                            <li><a aria-current="page" class="activated active" href="/certificate/foreigners?s=1">পাসপোর্ট (বাংলাদেশি/বিদেশি)</a></li>
                        </ul>
                        <div class="app-link">
                                        ...
                                        <div id="su-reg-status-form">
                                            <div class="row">
                                                <div class="col-md-6 mb-4">
                                                    ...
                                                    <input type="text" name="passport_no" style="text-transform: uppercase;" class="form-control" placeholder="AC0215425" autocomplete="off" id="passport_no" />
                                                </div>
                                                <div class="col-md-6 mb-4">
                                                    <label for="su-v-dob">Date of birth (according to passport):</label>
                                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mt-4"><button id="verify_send" disabled="" class="btn btn-primary btn-block">Verify</button></div>
                                            </div>
                                        </div>
                                        <br />
                                    </div>
