                        ...
                        <fieldset>
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-30 col-md-6 col-sm-6">
                                    ...
                                    <input class="from-control" type="text" id="pp_number" name="pp_number" placeholder="">
                                </div>
                                <div class="col-lg-6 mb-30 col-md-6 col-sm-6">
                                    <label for="dob">Date of Birth</label>
                                    <input class="from-control" type="text" id="dob" name="dob" placeholder="">
                                </div>
                                <div class="col-lg-6 mb-30 col-md-6 col-sm-6">
                                ...
                                <div class="col-lg-6 mb-30 col-md-6 col-sm-6">
                                    ...
                                    <input class="from-control" type="text" id="effective_date" name="effective_date" placeholder="">
                                </div> 
                               
                                <div class="col-lg-6 mb-30 col-md-6 col-sm-6">
                                    <label for="mobile">Mobile Number</label>
                                    <input class="from-control" type="text" id="mobile" name="mobile" placeholder="">
                                </div>
                                <div class="col-lg-6 mb-30 col-md-6 col-sm-6">
