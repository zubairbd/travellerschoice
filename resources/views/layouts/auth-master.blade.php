...
<html lang="zxx">  
    <head>
        ...
        <!-- flaticon css -->
        <link rel="stylesheet" type="text/css" href="{{asset('backend')}}/assets/fonts/flaticon.css">
        <!-- animate css -->
        <link rel="stylesheet" type="text/css" href="{{asset('backend')}}/assets/css/animate.css">
        <!-- owl.carousel css -->
        <link rel="stylesheet" type="text/css" href="{{asset('backend')}}/assets/css/owl.carousel.css">
        <!-- slick css -->
        <link rel="stylesheet" type="text/css" href="{{asset('backend')}}/assets/css/slick.css">
        <!-- off canvas css -->
        <link rel="stylesheet" type="text/css" href="{{asset('backend')}}/assets/css/off-canvas.css">
        <!-- magnific popup css -->
        <link rel="stylesheet" type="text/css" href="{{asset('backend')}}/assets/css/magnific-popup.css">
        <!-- Main Menu css -->
        <link rel="stylesheet" href="{{asset('backend')}}/assets/css/rsmenu-main.css">
        <!-- spacing css -->
        <link rel="stylesheet" type="text/css" href="{{asset('backend')}}/assets/css/rs-spacing.css">
        <!-- style css -->
        <link rel="stylesheet" type="text/css" href="{{asset('backend')}}/style.css"> <!-- This stylesheet dynamically changed from style.less -->
        <!-- responsive css -->
    ...
    <body class="defult-home">
            ...
            <div class="full-width-header">
                ...
                <nav class="right_menu_togle hidden-md">
                    ...
                    <div class="canvas-logo">
                        <a href="index.html"><img src="{{asset('backend')}}/assets/images/logo-dark.png" alt="logo"></a>
                    </div>
        ...
        <!-- Menu js -->
        <script src="{{asset('backend')}}/assets/js/rsmenu-main.js"></script> 
        <!-- op nav js -->
        <script src="{{asset('backend')}}/assets/js/jquery.nav.js"></script>
        <!-- owl.carousel js -->
        <script src="{{asset('backend')}}/assets/js/owl.carousel.min.js"></script>
        <!-- wow js -->
        <script src="{{asset('backend')}}/assets/js/wow.min.js"></script>
        <!-- Skill bar js -->
        <script src="{{asset('backend')}}/assets/js/skill.bars.jquery.js"></script>
        ...
        <!-- particles js -->
        <script src="{{asset('backend')}}/assets/js/particles.min.js"></script>  
        <!-- magnific popup js -->
        <script src="{{asset('backend')}}/assets/js/jquery.magnific-popup.min.js"></script>      
        <!-- plugins js -->
        <script src="{{asset('backend')}}/assets/js/plugins.js"></script>
        <!-- pointer js -->
        <script src="{{asset('backend')}}/assets/js/pointer.js"></script>
        <!-- contact form js -->
        <script src="{{asset('backend')}}/assets/js/contact.form.js"></script>
        <!-- ScrollIt js -->
        <script src="{{asset('backend')}}/assets/js/scrollIt.min.js"></script>
        <!-- main js -->
