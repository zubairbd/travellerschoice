...
@section('menu-open')active menu-open @endsection
@section('block')display:block @endsection
@section('gsetting')text-red @endsection
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 col-md-4">
                                            @if(@$setting->site_logo)
                                                <div class="bgimage" style="background-image:url({{ asset('backend/images/logo/'.@$setting->site_logo) }})"></div>
                                            @else
                                                <div class="bgimage favicon" style="background-image:url({{ asset('backend/images/logo/tanmisit-logo-blue.png') }}"></div>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 col-md-4">
                                            @if(@$setting->site_favicon)
                                                <img src="{{ asset('backend/images/logo/'.@$setting->site_favicon) }}" alt="Site Favicon" class="img-responsive favicon">
                                            @else
                                                <img src="{{ asset('backend/images/logo/favicon.png') }}" alt="Site Logo" class="img-responsive favicon" width="36">
                                            @endif
                                        </div>
                                    </div>
